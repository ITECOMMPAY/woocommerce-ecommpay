(function ($) {
        ...
        return $.ajax({
            ...
            success: function () {
                $.get(window.location.href, function (data) {
                    ...
                    newData = $(data).find('#' + that.infoBox.attr('id') + ' .inside').html();
    ...
    $(function () {
        ...
        emptyLogsButton.on('click', function (e) {
            ...
            $.getJSON(ajaxurl, {action: 'ecommpay_empty_logs'}, function (response) {
        ...
        flushCacheButton.on('click', function (e) {
            ...
            $.getJSON(ajaxurl, {action: 'ecommpay_flush_cache'}, function (response) {
                ecpInsertAjaxResponseMessage(response);
    ...
    function ECP() {
        ...
        this.postID = $('#post_ID');
        this.loaderBox = $('<div class="blockUI blockOverlay" style="z-index: 1000; border: medium none; margin: 0; padding: 0; width: 100%; height: 100%; top: 0; left: 0; background: rgb(255, 255, 255) none repeat scroll 0 0; opacity: 0.6; cursor: wait; position: absolute;"></div>');
    }
})(jQuery);
