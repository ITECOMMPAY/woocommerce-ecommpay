...
/**
 * EcpSettingsGiropay class
 *
 * @class    EcpSettingsGiropay
 * @version  3.0.0
 * @package  Ecp_Gateway/Settings
 * @category Class
 * @internal
 */
class EcpSettingsGiropay extends EcpSettings {
	...
	public function __construct() {
		...
		add_filter( EcpFiltersList::ECP_PREFIX_GET_SETTINGS . $this->id, [ $this, 'get_settings_giropay_methods' ] );
	}
	 ...
	 * @return array
	 */
	public function get_settings_giropay_methods(): array {
		$settings = [
			[
