...
/**
 * Ecp_Gateway_Settings_Brazil_Online_Banks class
 *
 * @class    Ecp_Gateway_Settings_Brazil_Online_Banks
 * @version  3.3.0
 * @package  Ecp_Gateway/Settings
 * @category Class
 * @internal
 */
class Ecp_Gateway_Settings_Brazil_Online_Banks extends Ecp_Gateway_Settings {
	...
	public function __construct() {
		...
		add_filter( 'ecp_get_settings_' . $this->id, [ $this, 'get_settings_brazil_methods' ] );
	}
