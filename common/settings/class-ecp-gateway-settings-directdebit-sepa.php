...
/**
 * Ecp_Gateway_Settings_DirectDebit_SEPA class
 *
 * @class    Ecp_Gateway_Settings_DirectDebit_SEPA
 * @version  3.4.3
 * @package  Ecp_Gateway/Settings
 * @category Class
 * @internal
 */
class Ecp_Gateway_Settings_DirectDebit_SEPA extends Ecp_Gateway_Settings {
	...
	public function __construct() {
		...
		add_filter( 'ecp_get_settings_' . $this->id, [ $this, 'get_settings_directdebit_sepa' ] );
	}
