...
/**
 * Ecp_Gateway_Settings_Sofort class
 *
 * @class    Ecp_Gateway_Settings_Sofort
 * @version  3.0.0
 * @package  Ecp_Gateway/Settings
 * @category Class
 * @internal
 */
class Ecp_Gateway_Settings_Sofort extends Ecp_Gateway_Settings
{
    // region Constants
    ...
    public function __construct()
    {
        ...
        add_filter('ecp_get_settings_' . $this->id, [$this, 'get_settings_sofort_methods']);
    }
