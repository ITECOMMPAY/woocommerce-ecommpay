...
/**
 * Ecp_Gateway_Settings_Ideal class
 *
 * @class    Ecp_Gateway_Settings_Ideal
 * @version  3.0.0
 * @package  Ecp_Gateway/Settings
 * @category Class
 * @internal
 */
class Ecp_Gateway_Settings_Ideal extends Ecp_Gateway_Settings
{
    // region Constants
    ...
    public function __construct()
    {
        ...
        add_filter('ecp_get_settings_' . $this->id, [$this, 'get_settings_ideal_methods']);
    }
