 ...
 *
 * @class    Ecp_Gateway_Giropay
 * @version  3.0.0
 * @package  Ecp_Gateway/Gateways
 * @category Class
 */
class Ecp_Gateway_Giropay extends Ecp_Gateway
{
    ...
    /**
     * <h2>Instance of ECOMMPAY Giropay Gateway.</h2>
     *
     * @var Ecp_Gateway
     * @since 3.0.0
     */
    ...
    {
        $this->id = Ecp_Gateway_Settings_Giropay::ID;
