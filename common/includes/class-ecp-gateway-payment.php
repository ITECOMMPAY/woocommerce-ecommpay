...
class Ecp_Gateway_Payment {
	 ...
	 * @since 2.0.0
	 */
	public function sort_operation( Ecp_Gateway_Info_Operation $a, Ecp_Gateway_Info_Operation $b ): int {
		switch ( true ) {
	 ...
	 * @since 2.0.0
	 */
	public function get_operation_by_request( string $request_id ): ?Ecp_Gateway_Info_Operation {
