 ...
 * @category Class
 */
class Ecp_Gateway_Refund extends \Automattic\WooCommerce\Admin\Overrides\OrderRefund
{
     ...
     * @since 2.0.0
     */
    public function set_ecp_status($status, $note = '')
    {
     ...
     * @since 2.0.0
     */
    private function get_valid_ecp_statuses()
    {
