 ...
 */
function ecp_exception_error_handler( int $severity, string $message, string $file, int $line ): void {
	throw new EcpGatewayErrorException( $message, 0, $severity, $file, $line );
}
