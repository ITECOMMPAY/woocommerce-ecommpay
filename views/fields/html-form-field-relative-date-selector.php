...
<tr>
	...
	<td class="forminp">
		<input name="<?php echo esc_attr( $id ); ?>[number]" id="<?php echo esc_attr( $id ); ?>" type="number"
			   ...
			   class="<?php echo esc_attr( $class ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" step="1"
			   min="1"
		...
		<select name="<?php echo esc_attr( $id ); ?>[unit]" style="width: auto;">
			<?php foreach ( $periods as $period => $label ): ?>
				<option
					value="<?php echo esc_attr( $period ); ?>" <?php echo selected( $option_value['unit'], $period, false ) ?>>
