...
<ul class="order_actions">
    ...
    <li class="wide">
        <?php if ($is_test) : ?>
            <p class="ecp-full-width is_test">
                <strong><?php esc_html_e('Test payment', 'woo-ecommpay'); ?></strong>
            </p>
        <?php endif; ?>
        <?php if (isset($payment_id) && !empty($payment_id)) : ?>
            <p class="ecp-full-width">
                <small>
                    <strong><?php esc_html_e('Payment ID', 'woo-ecommpay'); ?>:</strong>
        ...
        <?php if (isset($payment_method) && !empty($payment_method)) : ?>
            <p class="ecp-full-width">
                <small>
                    <strong><?php esc_html_e('Payment method', 'woo-ecommpay'); ?>:</strong>
        ...
        <?php if (isset($operation_type) && !empty($operation_type)) : ?>
            <p class="ecp-full-width">
                <small>
                    <strong><?php esc_html_e('Operation type', 'woo-ecommpay'); ?>:</strong>
        ...
        <?php if (isset($operation_code) && !empty($operation_code)) : ?>
            <p class="ecp-full-width">
                <small>
                    <strong><?php esc_html_e('Code', 'woo-ecommpay'); ?>:</strong>
        ...
        <?php if (isset($operation_message) && !empty($operation_message)) : ?>
            <p class="ecp-full-width">
                <small>
                    <strong><?php esc_html_e('Message', 'woo-ecommpay'); ?>:</strong>
    ...
    <li class="wide">
        <strong class="ecp-amount"><?php echo wp_kses_post($amount); ?></strong>
